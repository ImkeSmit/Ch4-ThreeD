...
library(stringi)
library(readxl)
import_community_2026 <- function(metaTurfID, filepath){ #e.g., "All_data/raw_data/raw_threed_data/2025"
  
  #### COMMUNITY DATA ####
  ### Read in files
  files <- dir(path = filepath, pattern = "\\.xlsx$", full.names = TRUE, recursive = F)
